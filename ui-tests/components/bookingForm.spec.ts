...
test("Can submit the booking form", async ({ page }) => {
  ...
  await page.getByPlaceholder("how can we help you").fill(`<br><br>Hi Account Managers,<br><br> This is a weekly test email to verify that the create lead flow is working. ${
