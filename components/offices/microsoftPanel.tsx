	...
	return (
		<>
			...
			<div className="border-2 bg-gray-100 px-4 py-2">
				...
				/>
				<p>
				  Microsoft Cloud Partners are the elite Microsoft Business Partners
				  who earn the highest customer endorsement. They have the
					knowledge, skills, and commitment to help implement technology
					solutions that match your exact business needs. Microsoft Cloud Partners 
					have passed the highest level of requirements from
