...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="my-0 flex">
    ...
    >
      {children}
      <Plus className="size-6 shrink-0 transition-transform duration-200 motion-reduce:transition-none motion-reduce:duration-0" />
    </AccordionPrimitive.Trigger>
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ref={ref}
    className="overflow-hidden text-base font-light text-white data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down motion-reduce:animate-none"
    {...props}
  >
