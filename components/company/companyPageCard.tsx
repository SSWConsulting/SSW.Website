...
const CompanyPageCard: FC<CompanyIndexProps> = ({ title, body, pageURL }) => {
  return (
    <Link
      ...
      key={pageURL}
    >
      <article className="prose col-span-1 h-fit w-full rounded border-1 border-gray-300 bg-white p-4 shadow hover:border-sswBlack  dark:border-gray-700 dark:bg-gray-800 sm:h-44">
