...
export const TechnologyLinks = () => (
  <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 py-1">
    ...
    <CustomLink
      ...
      className="unstyled flex min-h-6 items-center gap-1 p-1 text-gray-300 underline-offset-2 hover:text-sky-300 hover:underline"
    >
      <Image src="/images/logos/azure.png" alt="" height={16} width={16} />
      <span className="uppercase tracking-wider">Built on Microsoft Azure</span>
    </CustomLink>
  </div>
);
