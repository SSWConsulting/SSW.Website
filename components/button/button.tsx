  ...
  return (
    ...
    >
      ...
      {ripple && <div className={
          classNames(
              "absolute top-1/2 left-1/2 before:relative before:mt-[100%] before:block before:content-[''] after:absolute after:inset-0 after:rounded-[50%] after:content-[''] -translate-x-1/2 -translate-y-1/2", 
