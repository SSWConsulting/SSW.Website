...
export function MegaMenuWrapper(props) {
  ...
  // (search / region globe / Let's Talk). Only THEMED_ROUTES additionally opt
  ...
  const isThemed = isThemedRoute(pathName);
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        isThemed && "xl:-mx-6 min-[1360px]:mx-0",
        ...
        isThemed && isDark && "dark"
      )}
    >
      {isThemed && <HomeThemePrePaint />}
      <MegaMenuLayout
        hidePhone={
        ...
        rightSideActionsOverride={() => <HomeNavActions isThemed={isThemed} />}
        ...
        mobileMenuClassName={isThemed && isDark ? "dark" : undefined}
        linkComponent={(props) => (
          <CustomLink
            {...props}
