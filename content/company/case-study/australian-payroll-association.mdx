...
content: |
  ...
  * Bad advice on award interpretation or terminations
  ...
  <CustomImage src="/images/case-studies/apa-chatgpt-response.png" altText="ChatGPT giving an incorrect answer about minimum hours for part-time nurses under the Nurses Award" width={950} height={500} caption="Figure: ChatGPT confidently gives an incorrect answer about part-time nurse minimum hours" alignment="items-start" customClass="Vertical margin (my-0)" />
  ...
  * Current data: Award changes roll in overnight without PDF updates.
  ...
  <CustomImage src="/images/case-studies/apa-beryl-response.png" altText="Beryl, APA's AI Payroll Agent, providing an accurate and detailed answer about minimum hours for part-time nurses under the Nurses Award" width={950} height={500} caption="Figure: Beryl correctly explains that part-time nurse shift lengths are governed by individual written agreements" alignment="items-start" customClass="Vertical margin (my-0)" />
