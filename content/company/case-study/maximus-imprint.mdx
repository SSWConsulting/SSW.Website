...
content: >
  ...
  <FixedColumns
    firstColBody={<>
      <CustomImage src="/images/case-studies/maximus-imprint-3.jpg" altText="Search for a performance review - Gantt Chart View" caption="Figure 3: Search for a performance review - Gantt Chart View" height={330} width={319} />
    </>}
    secondColBody={<>
