...
seo:
  ...
  description: >-
    Visit our page to explore SSW, a leading software development company.
    Discover our logo, values, and innovative tech solutions.
  showBreadcrumb: true
...
_body:
  ...
  - title: Download
    downloads:
      - header: Color
        img: /images/company-logos/ssw-logo-preview1.png
        imgBackground: white
  ...
  - title: SSW Colors
    ...
    colorRow:
      ...
      - firstColor: '#AAAAAA'
        ...
        caption: "More standard colors can be found at\_[SSW Typography & Web Design References - Colors](https://www.ssw.com.au/ssw/company/Web-Reference.aspx#Colors)\_page.\n"
  ...
  - content: >
      ...
      alignment="items-start" inline={true} customClass="my-0 items-center"
      altText="ssw logo compressed" width={260} height={260} />


      <CustomImage src="/images/company-logos/ssw-logo_compressed.png"
      altText="ssw logo - altered" alignment="items-start" height={260}
      width={260} inline={true} customClass="my-0"
      caption="Don't compress the logo..." />
      ...
      width={260} inline={true} customClass="my-0"
      caption="Don't alter the colors..." />


      <CustomImage src="/images/company-logos/ssw-logo_symbol-resize.png"
      height={260} width={260} alignment="items-start" inline={true}
      altText="ssw logo - insufficient contrast" customClass="my-0"
      caption="Don't change the size of the &#x22;swoosh&#x22;..." />
      ...
      width={260} inline={true} customClass="my-0" link=""
      caption="Don't place the logo on backgrounds that provide insufficient contrast..." />


      <CustomImage src="/images/company-logos/ssw-logo_font-change.png"
      altText="ssw logo - shapes " alignment="items-start" height={260}
      width={260} inline={true} customClass="my-0"
      caption="Don't change the font..." />
      ...
      inline={true} customClass="my-0"
      caption="Don't place the logo inside shapes..." />


      <CustomImage src="/images/company-logos/ssw-logo_busy-bg.png" altText="ssw
      logo - 3d" alignment="items-start" height={260} width={260}
      inline={true} customClass="my-0"
      caption="Don't place the logo on a visually cluttered or patterned background..." />


      <CustomImage src="/images/company-logos/ssw-logo_3d.png" altText="ssw logo
      - 3d " alignment="items-start" height={260} width={260} inline={true}
      customClass="my-0"
