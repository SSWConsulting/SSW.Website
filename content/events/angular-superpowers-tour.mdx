      ...
      - placeholder: Stage 1
        body: |
          <VerticalListItem
            ...
            icon="/images/icons/stage-1-icon.png"
            afterBody={<>
      ...
      - placeholder: Stage 2
        body: |
          <VerticalListItem
            ...
            icon="/images/icons/stage-2-icon.png"
          />
      - placeholder: Stage 3
        body: |
          <VerticalListItem
            ...
            icon="/images/icons/stage-3-icon.png"
          />
      - placeholder: Stage 4
        body: |
          <VerticalListItem
            ...
            icon="/images/icons/stage-4-icon.png"
          />
      - placeholder: Stage 5
        body: |
          <VerticalListItem
            ...
            icon="/images/icons/stage-5-icon.png"
          />
    _template: Agenda
...
eventHeader:
  heroBackground: /images/background/polygonBackground.png
  imgOverlay: /images/background/SuperPower-FBC-Angular.png
---
