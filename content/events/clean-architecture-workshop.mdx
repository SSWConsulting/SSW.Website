---
eventHeader:
  heroBackground: /images/background/banner-custom-trainings.jpg
...
title: <span class="text-sswRed">Clean Architecture Workshop</span>
subTitle: >-
  Welcome to the world of Clean Architecture Workshop! Discover the
