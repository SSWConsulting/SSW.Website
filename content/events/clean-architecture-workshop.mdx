...
seo:
  ...
  description: The Clean Architecture Workshop - Best approach to building enterprise applications using Clean Architecture and .NET
  images:
...
subTitle: |
  ...
  maintainable software. Ideal for developers proficient in C#.
