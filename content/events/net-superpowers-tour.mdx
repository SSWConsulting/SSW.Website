...
_body:
  ...
  - content: >
      **.NET 8 has replaced .NET 7, .NET 6, and .NET Core 3.1, and is the latest
      ...
      <VideoEmbed url="https://youtu.be/OcWXtL75_CA?si=JGKtDE4hC_uktXxk" caption="Video: Unleash the Potential of .NET 8 with the New .NET Superpowers Tour, Presented by Matt Goldman (1 min)" />
    size: lg
    align: center
    _template: Content
