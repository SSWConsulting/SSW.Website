...
_body:
  ...
  - title: ''
    content: >
      .NET 8 is the latest Long-Term Support (LTS) version in .NET. Our .NET
      ...
      day with a solid understanding of why you should be using .NET 8 for all
      ...
      the Potential of .NET 8 with the New .NET Superpowers Tour, Presented by
      Matt Goldman" duration="1 min" />
    size: lg
    align: center
    _template: Content
footer: ''
