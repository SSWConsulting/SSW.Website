...
_body:
  ...
  - title: ''
    content: ".NET 8\_is the latest Long-Term Support (LTS) version in .NET.\n\n\nOur .NET experts can get you ready to use the most powerful version ever! This fast-paced 1-day course covers many topics, such as Cloud-Native Web Application development with ASP.NET Core, data access with EF Core, automated testing, and many other enterprise topics.\n\n\nYou will finish the day with a solid understanding of why you should be using .NET 8\_for all your small, medium and enterprise business projects.\n\n<VideoEmbed url=\"https://youtu.be/OcWXtL75_CA?si=JGKtDE4hC_uktXxk\" caption=\"Unleash the Potential of .NET 8 with the New .NET Superpowers Tour, Presented by Matt Goldman\" duration=\"1 min\" />\n"
    size: lg
    align: center
    _template: Content
footer: ''
