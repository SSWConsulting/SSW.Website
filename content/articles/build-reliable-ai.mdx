...
subTitle: >
  ...
  ***
  ...
  uses output guardrails to block advice on illegal investments, speculative
  statements like “always invest in X” and hate speech or inappropriate
  language. |
  ...
  natural. | Raw user input: “Is this drug safe for
  kids?                                                                                                                                                                                                                                                                 
  |
  ...
  ***
  ...
  ## Implementation Blueprint: Python + AutoGen
