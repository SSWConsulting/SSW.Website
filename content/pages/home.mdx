...
<ColumnLayout
  ...
  message={<>
    ...
    In 1999, we were first recognized as a Microsoft Gold Partner. Today SSW has competencies in a variety of areas, earning gold in Application Development, Application Integration, Cloud Platform, DevOps; and silver inCollaboration and Content, and Data Analytics.
  </>}
/>
...
<ColumnLayout
  ...
  height={125}
  message={<>
    We are proud to announce we have won the MAPA - Microsoft Australia Partner Award - for Excellence in Learning for [SSW FireBootCamp](https://www.firebootcamp.com/). We were chosen from a national field of top Microsoft Partners for delivering market-leading customer solutions built on the Microsoft platform.
  </>}
/>
