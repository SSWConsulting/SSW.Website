...
<ColumnLayout
  ...
  message={<>
    ...
    In 1999, we were first recognized as a Microsoft Gold Partner. Today [SSW has competencies in a variety of
    areas](https://www.ssw.com.au/ssw/company/awards/), earning gold in
    **Application Development**, **Application Integration**, **Cloud
    Platform**, **DevOps**; and silver in **Collaboration and Content**, and
    **Data Analytics**.
  </>}
/>
