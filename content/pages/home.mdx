...
breadcrumbs: false
beforeBody:
  - link: 'https://ssw.com.au/consulting'
    badges: content/technologyBadges/default.json
    _template: LatestTech
  - items:
      ...
      - label: >-
        ...
        openIn: sameWindow
        imgSrc: /images/carousel/Need-help-Jean.jpg
      - label: Vertical slices Vs the world
        link: 'https://www.ssw.com.au/ssw/NETUG/Brisbane.aspx'
        openIn: sameWindow
        imgSrc: /images/carousel/Vertical-Slice-Vs-The-World-Carousel.jpg
  ...
  - bigCardsLabel: Consulting
    bigCards:
      ...
      - title: Data & AI
        description: >
          Custom solutions using advanced AI technologies such as machine
          learning and ChatGPT for your data and workflows
...
SSW Consulting has over 30 years of experience developing awesome Microsoft solutions that today build on top of Angular, React, Vue, Azure, Azure DevOps (was TFS), SharePoint, Office 365, Blazor, .NET, WebAPI, Dynamics 365, and SQL Server. [Know more](https://www.ssw.com.au/ssw/Company/AboutUs.aspx)
