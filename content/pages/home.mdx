...
beforeBody:
  - items:
      - label: Join us in Newcastle
        link: 'https://slashnew.tech/'
        openIn: sameWindow
        imgSrc: /images/carousel/slash-new-banner.jpg
      - label: tinacms now powered by SSW
        link: 'https://www.tina.io'
        openIn: newWindow
        imgSrc: /images/carousel/Tina-SSW-website-banner_v2.png
      - label: Serverless Days ANZ 2024
        link: 'https://anz.serverlessdays.io/'
        openIn: newWindow
        imgSrc: /images/carousel/Serverless-Days-ANZ-2024-website-banner.png
