...
seo:
  description: >-
    ...
    France and China. We use Angular, React, .NET, Azure, Dynamics 365 CRM.
...
beforeBody:
  - items:
      - label: Meet us at NDC Oslo
        link: 'https://ndcoslo.com/'
        openIn: newWindow
        imgSrc: /images/carousel/NDCOslo.jpg
      - label: June Full Stack User Group with Jack Pettit
        link: 'https://www.ssw.com.au/netug/brisbane'
        openIn: newWindow
        imgSrc: /images/carousel/Full-Stack-User-Group-Jack-Pettit-Website-Banner.jpg
  ...
  - bigCardsLabel: Consulting
    ...
    smallCards:
      - title: Training
        link: 'https://www.ssw.com.au/events'
        color: darkgray
...
SSW Consulting has over 30 years of experience developing awesome Microsoft solutions that today build on top of Angular, React, Vue, Azure, Azure DevOps (formally TFS), SharePoint, Office 365, Blazor, .NET, WebAPI, Dynamics 365, and SQL Server. [More on SSW's consulting services.](https://www.ssw.com.au/consulting "More on SSW's consulting services")
