...
seo:
  description: >-
    30 years of Microsoft software and web development experience. Leaders in Artificial intelligence (AI), Angular, React, .NET, Azure, and Dynamics 365 CRM.
  ...
  - bigCardsLabel: Consulting
    bigCards:
      ...
      - title: Artificial Intelligence
        description: >-
          Custom AI solutions using LLMs (ChatGPT, Llama, Gemini, Claud, etc)
          and Azure AI to revolutionalise your business
        link: /consulting/artificial-intelligence
        color: lightgray
