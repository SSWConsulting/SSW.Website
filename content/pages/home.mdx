...
beforeBody:
  - items:
      ...
      - label: Evolve Your Codebase As You Scale
        link: 'https://www.ssw.com.au/netug/melbourne'
        openIn: sameWindow
      ...
      - label: Vercel simplifying your development
        ...
        openIn: sameWindow
        imgSrc: >-
          /images/carousel/vercel-simplifying-your-development-with-zero-configuration-Carousel.jpg
  ...
  - bigCardsLabel: Consulting
    ...
    smallCards:
      ...
      - title: Book an Expert
        link: 'https://www.ssw.com.au/company/contact-us'
        color: darkgray
