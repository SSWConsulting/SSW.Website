...
<TableLayout
  ...
  rows={[
    { cells: [ { cellValue: "Security Specialist" }, { cellValue: "$525 + GST" }, { cellValue: "$4,200 + GST" }, { cellValue: "$510 + GST" }, { cellValue: "<strong>$4,080</strong> + GST" } ] },
    { cells: [{ cellValue: "Chief Architect" }, { cellValue: "$345 + GST" }, { cellValue: "$2,760 + GST" }, { cellValue: "$330 + GST" }, { cellValue: "<strong>$2,640</strong> + GST" } ] },
    { cells: [{ cellValue: "Solution Architect" },{ cellValue: "$325 + GST" }, { cellValue: "$2,600 + GST" }, { cellValue: "$310 + GST" }, { cellValue: "<strong>$2,480</strong> + GST" } ] },
    { cells: [{ cellValue: "Delivery Lead" },{ cellValue: "$325 + GST" }, { cellValue: "$2,600 + GST" }, { cellValue: "$310 + GST" }, { cellValue: "<strong>$2,480</strong> + GST" } ] },
    { cells: [{ cellValue: "Senior Software/Data Engineer II" },{ cellValue: "$305 + GST" }, { cellValue: "$2,440 + GST" }, { cellValue: "$290 + GST" }, { cellValue: "<strong>$2,320</strong> + GST" } ] },
    { cells: [{ cellValue: "Senior Software/Data Engineer I" },{ cellValue: "$285 + GST" }, { cellValue: "$2,280 + GST" }, { cellValue: "$270 + GST" }, { cellValue: "<strong>$2,160</strong> + GST" } ] },
    { cells: [{ cellValue: "Software/Data Engineer II" },{ cellValue: "$265 + GST" }, { cellValue: "$2,120 + GST" }, { cellValue: "$250 + GST" }, { cellValue: "<strong>$2,000</strong> + GST" } ] },
    { cells: [{ cellValue: "Software/Data Engineer I" },{ cellValue: "$245 + GST" }, { cellValue: "$1,960 + GST" }, { cellValue: "$230 + GST" }, { cellValue: "<strong>$1,840</strong> + GST" } ] },
    { cells: [{ cellValue: "Software/Data Developer" },{ cellValue: "$205 + GST" }, { cellValue: "$1,640 + GST" }, { cellValue: "$190 + GST" }, { cellValue: "<strong>$1,520</strong> + GST" } ] },
    { cells: [{ cellValue: "Associate Software/Data Developer" },{ cellValue: "$165 + GST" }, { cellValue: "$1,320 + GST" }, { cellValue: "$150 + GST" }, { cellValue: "<strong>$1,200</strong> + GST" } ] },
    { cells: [{ cellValue: "Low-Code/Power Platform Architect" },{ cellValue: "$245 + GST" }, { cellValue: "$1,960 + GST" }, { cellValue: "$230 + GST" }, { cellValue: "<strong>$1,840</strong> + GST" } ] },
    { cells: [{ cellValue: "Low-Code/Power Platform Senior Developer" },{ cellValue: "$205 + GST" }, { cellValue: "$1,640 + GST" }, { cellValue: "$190 + GST" }, { cellValue: "<strong>$1,520</strong> + GST" } ] },
    { cells: [{ cellValue: "Senior System Administrator" },{ cellValue: "$285 + GST" }, { cellValue: "$2,280 + GST" }, { cellValue: "$270 + GST" }, { cellValue: "<strong>$2,160</strong> + GST" } ] },
    { cells: [{ cellValue: "System Administrator" },{ cellValue: "$245 + GST" }, { cellValue: "$1,960 + GST" }, { cellValue: "$230 + GST" }, { cellValue: "<strong>$1,840</strong> + GST" } ] },
    { cells: [{ cellValue: "Senior UI/UX Designer" },{ cellValue: "$265 + GST" }, { cellValue: "$2,120 + GST" }, { cellValue: "$250 + GST" }, { cellValue: "<strong>$2,000</strong> + GST" } ] },
    { cells: [{ cellValue: "UI/UX Designer" },{ cellValue: "$225 + GST" },{ cellValue: "$1,800 + GST" }, { cellValue: "$210 + GST" }, { cellValue: "<strong>$1,680</strong> + GST" } ] },
    { cells: [{ cellValue: "Marketing/Content Writing/SEO Expert" },{ cellValue: "$245 + GST" },{ cellValue: "$1,960 + GST" }, { cellValue: "$230 + GST" }, { cellValue: "<strong>$1,840</strong> + GST" } ] },
    { cells: [{ cellValue: "Video Producer/Director" },{ cellValue: "$265 + GST" },{ cellValue: "$2,120 + GST" }, { cellValue: "$250 + GST" }, { cellValue: "<strong>$2,000</strong> + GST" } ] },
  ]}
  tableStyle="styled"
  firstColBold={true}
/>
