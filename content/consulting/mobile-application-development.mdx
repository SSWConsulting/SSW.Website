...
seo:
  ...
  description: >
    If you use mobile apps on an iPhone or an Android phone then you know that 
    mobile phones are an essential tool for business, just like a laptop. 
    Wireless providers have increased their bandwidth and accessibility, 
    opening up more opportunities than ever before. Businesses are gaining a 
    competitive edge through apps that allow them to become more efficient. 
    SSW can build mobile apps using React Native, Xamarin, Flutter, Cordova, 
    PWA or Ionic!
---
