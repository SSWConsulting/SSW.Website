...
benefits:
  benefitList:
    ...
    - image: /images/benefits/security.png
      ...
      description: >
        🔐 Using a password manager like Keeper is essential for maintaining
        strong, unique passwords across all your accounts. We recommend Keeper
        for secure password storage, sharing, and multi-factor authentication.
  rule:
    - name: SSW Rules to Better Security
      url: 'https://www.ssw.com.au/rules/rules-to-better-security/'
    - name: Use a Password Manager
      url: 'https://www.ssw.com.au/rules/password-managers/'
technologies:
