...
benefits:
  benefitList:
    ...
    - image: /images/benefits/security.png
      ...
      description: >
        🔐 Using a password manager is essential for maintaining strong, unique
        passwords across all your accounts. We recommend Keeper for secure
        password storage, sharing, and multi-factor authentication.
  rule:
