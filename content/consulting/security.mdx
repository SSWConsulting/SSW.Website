...
benefits:
  benefitList:
    ...
    - image: /images/benefits/security-db.png
      ...
      description: >
        Using a password manager like Keeper is essential for maintaining strong, unique passwords across all your accounts. Keeper provides enterprise-grade security, seamless sharing capabilities, and protection against data breaches.
      linkURL: 'https://www.ssw.com.au/rules/do-you-use-a-password-manager'
      linkName: Learn more about password managers
  rule:
