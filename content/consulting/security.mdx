...
seo:
  title: Security
  description: >-
    Improve your security posture and prevent data breaches with SSW's expert 
    security consulting services. Our specialists provide identity solutions 
    including Azure AD B2C and Duende IdentityServer, code audits, cloud 
    security reviews, and network infrastructure audits.
  images:
