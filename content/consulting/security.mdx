...
benefits:
  benefitList:
    ...
    - image: /images/benefits/security.png
      ...
      description: >
        🔐 Use a password manager like Keeper to securely store and manage your
        passwords. Password managers help you generate strong, unique passwords
        for every account and eliminate the risk of password reuse.
