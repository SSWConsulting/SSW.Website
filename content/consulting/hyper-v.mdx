...
seo:
  ...
  description: >-
    SSW Consulting can assist with designing and implementing an 
    infrastructure that's stable, fast, and scalable, allowing you to 
    consolidate multiple server roles into separate virtual machines. We leverage 
    Failover Cluster Manager to link multiple physical machines running Hyper-V 
    and achieve real-time failover of virtual machines to another device. 
  images:
