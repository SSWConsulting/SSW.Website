...
solution:
  project: data
callToAction: Talk to us about <span class="text-sswRed">your data</span> today
medias:
  header: Media
  mediaCards:
    - type: video
...
seo:
  title: Power BI
  images:
    - url: /images/consulting/open-graph/powerbi.jpg
      width: 1200
      height: 629
      alt: SSW Power BI Consulting - Enterprise Software Development
  description: >
    Power BI is a cloud based business analytics service, allowing anyone to 
    visualize and analyse data with greater speed, efficiency and understanding.
---
