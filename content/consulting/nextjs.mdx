...
such as server-side rendering, automatic optimisation, and API routes. It has become one of the 
...
a dedicated backend server for your web app. Its as easy as creating a file in the API 
...
Next.js has been the tool of choice for a wide range of organisations, including 
