...
Next.js is a React meta-framework that adds a wide variety of invaluable features to React, 
such as server-side rendering, automatic optimisation, and API routes. 


Next.js' server-side rendering capabilities mean that you don't have to worry about
SEO issues that are common with client-side rendered single page applications (SPAs).