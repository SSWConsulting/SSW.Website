...
<FixedTabsLayout
  ...
  firstBody={<>
    ...
    * [Angular](https://www.ssw.com.au/consulting/angular) & [React expert](https://www.ssw.com.au/consulting/react)
  ...
  secondBody={<>
    ...
    <CustomImage src="/images/company/SSW-Project-Technologies-Report-v2.png" altText="Technology - Category Trend " width={1024} height={800} customClass="py-5" />
    
    <CustomImage src="/images/company/SSW-Sprint-Review-Report.png" altText="Sprint Reviews - Developers " height={800} width={1024} customClass="py-5" />
