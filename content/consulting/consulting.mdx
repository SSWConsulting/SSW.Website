...
<FixedTabsLayout
  ...
  firstBody={<>
    ...
    * [.Net Expert]("https://www.ssw.com.au/consulting/net-8")
    * [AI Expert](https://www.ssw.com.au/consulting/gpt)
    * [Angular](https://www.ssw.com.au/consulting/angular) or [React Expert](https://www.ssw.com.au/consulting/react)
  ...
  secondBody={<>
    ...
    <CustomImage src="/images/company/SSW-Project-Technologies-Report.png" altText="Technology - Category Trend " width={1024} height={800} customClass="py-6" />

    <CustomImage src="/images/company/SSW-Sprint-Review-Report.png" altText="Sprint Reviews - Developers " height={800} width={1024} customClass="py-6" />
