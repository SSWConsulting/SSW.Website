...
seo:
  ...
  description: >-
    SSW Support Plans offer peace of mind for enterprise software development, 
    providing insurance and priority support in case of emergencies. With 
    flexible options and accessible dashboards, SSW helps clients lower costs 
    and rest easy knowing their systems are secure and fast. Choose the level 
    of urgency for each issue and pay only for what you use.
  images:
