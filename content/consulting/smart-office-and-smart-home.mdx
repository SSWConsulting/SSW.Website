...
seo:
  ...
  images:
    - url: /images/consulting/open-graph/smart-office.jpg
      width: 1200
      height: 629
      alt: SSW Smart Office and Smart Home Consulting - Enterprise Software Development
  description: >
    The term "smart" is used to describe many different things. Essentially, an 
    office or house becomes smart when its many systems (lights, climate control, 
    music, blinds, air conditioners etc) are tied together under a master control 
    system that can perform automated tasks. The system is accessible from your 
    phone, from anywhere.
---
