...
<FixedColumns
  ...
  secondColBody={<>
    <EventLink
    content={<>
    ### Strasbourg .NET User Group  <Flag country="France" />
    
    SSW organizes and livestreams the Strasbourg .NET User Group, where developers gather to exchange ideas and attend presentations by local and international industry experts.
    </>}
    eventThumbnail="/images/events/strasbourg-user-group.webp"
    thumbnailAlt="Strasbourg Net User Group"
    link="https://ssw.fr/events"
    />
  </>}
/>
