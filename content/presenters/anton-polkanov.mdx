...
skills: >-
  ...
  Azure AI Services (Cognitive Services) | Azure App Service | Azure Container
  Apps | Azure DevOps | Azure Functions | Azure Key Vault | Azure SQL | Azure
  Storage | Azure Virtual Machines | Bicep | Contentful CMS | Cosmos DB |
  Database Performance | DevOps | Docker | EF Core | GitHub Actions | GraphQL |
  IdentityServer | Mentoring | Mobile Apps - Android/Native | Next.js | Python |
  React | Semantic Kernel | Stripe | Training | TypeScript | UX | .NET | .NET
  MAUI | .NET Web APIs | AI | ASP.NET Core | Blazor | ChatGPT Prompt Engineering
  | Clean Architecture | Code Review | Domain-Driven Design | GitHub | Mobile
  Apps - Xamarin | Modular Monolith | Scrum | SQL | SQL Server | Unit Testing |
