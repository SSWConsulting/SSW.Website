...
skills: >-
  ...
  Prompt Engineering | Data Protection Manager | Dynamics 365 - CRM | GitHub |
  HubSpot | Hyper-V | Microsoft Planner | Network - Routing and Switching |
  Office 365 Backup | Power Apps | Power Automate | Power Platform | PowerShell
  | Security | SharePoint | Terraform | WordPress | Azure | Azure AD B2C | Azure
  App Service | Azure Entra ID (was Azure Active Directory) | Azure Key Vault |
  Customer Service | Microsoft Excel | Microsoft Intune | Microsoft Outlook |
  Microsoft PowerPoint | Microsoft Teams (Admin) | Microsoft Word | Office 365 |
  Support | Zendesk
