...
skills: >-
  ...
  Active Directory) | Azure Event Hubs | Azure Front Door | Azure Key Vault |
  Azure OpenAI Service | Azure Search | Azure Virtual Network | BI | Bicep |
  Bitbucket | Blazor | ChatGPT Prompt Engineering | Cognitive Services | Cosmos
  DB | Database Performance | Docker | EF Core | IdentityServer | Kubernetes |
