---
skills: ".NET | Adobe Photoshop | AI | Angular | Application Insights | Azure | Azure Storage | Bootstrap | ChatGPT Prompt Engineering | Clean Architecture | CSS | EF Core | GitHub Actions | jQuery | Node.js | OpenAI API | Python | SQL | SQL Server | TypeScript | HTML5 | NestJS | Next.js | React | Tailwind | \U0001F999 TinaCMS"
