---
skills: ".NET | .NET 8 Migration | AI | Angular | Application Insights | ASP.NET Core | AWS | Azure DevOps | Blazor | CSS | GitHub | HTML5 | JavaScript | PHP | React | Scrum | SQL | TypeScript | \U0001F999 TinaCMS"
