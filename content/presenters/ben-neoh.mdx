---
skills: ".NET Framework | AI | Application Insights | ARM Templates | Auth0 | Azure API Management | Azure Entra ID (was Azure Active Directory) | Azure OpenAI Service | Azure Static Websites | Azure Storage | Azure Virtual Network | Bootstrap | Code Review | Cosmos DB | Cypress | DevOps | Docker | EF Core | GitHub Actions | GraphQL | IdentityServer | Markdown | Mentoring | Power Automate | Power BI | PowerShell | Scrum | SharePoint | SQL | SQL Server | Training | .NET | .NET 8 Migration | .NET MVC | .NET Web APIs | Angular | Azure | Azure App Service | Azure DevOps | Azure Functions | Azure Key Vault | Azure SQL | Bicep | CSS | Dynamics 365 - CRM | GitHub | HTML5 | JavaScript | Next.js | Playwright | Power Apps | Power Platform | React | TypeScript | \U0001F999 TinaCMS"
