---
skills: >-
  Angular | Application Insights | AWS | Bootstrap | Clean Architecture | CSS |
  Domain-Driven Design | Dynamics 365 - CRM | EF Core | Figma | Kubernetes |
  Power BI | React | SQL | Tailwind | TypeScript | Vertical Slice Architecture |
  Vue | .NET | Azure DevOps | Bicep | Blazor | DevOps | Docker | Fabric | GitHub
  | GitHub Actions | Scrum | Terraform
