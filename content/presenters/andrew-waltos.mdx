---
skills: "Angular | ASP.NET Core | AWS | Azure | Azure App Service | Azure DevOps | Azure Front Door | Azure Key Vault | Blazor | Cosmos DB | CSS | Figma | GitHub | GitHub Actions | GraphQL | HTML5 | Node.js | Release management | SQL | TypeScript | .NET | JavaScript | React | \U0001F999 TinaCMS"
