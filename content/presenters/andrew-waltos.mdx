---
skills: "Angular | ASP.NET Core | AWS | Azure | Azure App Service | Azure DevOps | Azure Front Door | Azure Key Vault | Blazor | Contentful CMS | Cosmos DB | CSS | Dynamics 365 - CRM | Figma | Google Analytics | GraphQL | HTML5 | Markdown | Next.js | Node.js | PowerShell | Scrum | SQL | TypeScript | Web Design & UX | WordPress | .NET | JavaScript | React | Tailwind | \U0001F999 TinaCMS"
