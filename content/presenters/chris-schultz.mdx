...
skills: >-
  ...
  | Azure Entra ID (was Azure Active Directory) | Azure Virtual Machines | Data
  Protection Manager | Hyper-V | Microsoft Intune | Microsoft Teams (Admin) |
  Network - Routing and Switching | Office 365 | Support | WordPress | Zendesk
position: Senior System Administrator
presenter:
  name: Chris Schultz
  peopleProfileURL: 'https://www.ssw.com.au/people/chris-schultz'
about: >-
