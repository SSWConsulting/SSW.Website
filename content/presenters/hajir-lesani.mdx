...
about: >-
  ...
  Specializing in .NET development, Next.js/React front-end applications, SQL
  database management, Azure cloud solutions, Hajir builds robust and scalable
  applications to meet complex business needs. His expertise extends to
  implementing secure authentication solutions with Azure B2C and ensuring
  enterprise-grade security across all applications. His ability to deliver
  effective solutions is matched by his commitment to exceeding client
  expectations.
