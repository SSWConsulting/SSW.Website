...
skills: >-
  ...
  Playwright | Power BI | PowerShell | .NET Web APIs | AI | Angular | Azure AD
  B2C | Azure Functions | Azure Logic App | Azure OpenAI Service | Bicep |
  ChatGPT Prompt Engineering | Dynamics 365 - CRM | HTML5 | Microsoft Teams
