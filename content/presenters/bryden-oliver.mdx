...
skills: >-
  ...
  Services | Azure Data Factory | Azure Entra ID (was Active Directory) | Azure
  Front Door | Azure Key Vault | Azure Logic App | Azure ML | Azure Search |
  Azure SignalR | Azure Storage | Azure Virtual Machines | Azure Virtual Network
  | Clean Architecture | Dynamics 365 - CRM | Exploratory testing | Machine
  Learning | Power BI | Scrum | Security | Test management | Test strategy |
  .NET | .NET Framework | .NET MVC | .NET Web APIs | Application Insights | ARM
  Templates | ASP.NET | ASP.NET Core | Azure | Azure App Service | Azure
  Databricks | Azure Event Hubs | Azure Functions | Azure SQL | Azure Stream
  Analytics | Azure Synapse | BI | Bicep | Blazor | Code Review | Cosmos DB |
  Database Performance | DevOps | EF Core | GitHub Actions | Mentoring |
