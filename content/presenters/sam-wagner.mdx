...
skills: >-
  ...
  Review | Docker | EF Core | Flutter | GitHub | Mentoring | Next.js | Power
  Automate | React | SQL | SQL Server | Unit Testing | Vertical Slice
  Architecture | Web Design & UX | .NET | .NET Web APIs | Angular | ASP.NET Core
  | Blazor | CSS | HTML5 | JavaScript | Markdown | Node.js | Scrum | Tailwind |
  TypeScript
