...
skills: >-
  ...
  Azure Active Directory) | Blazor | Clean Architecture | IdentityServer |
  Markdown | Mentoring | Mobile Apps - Xamarin | PowerShell | Scrum | Security |
  Strategic architecture | Training
