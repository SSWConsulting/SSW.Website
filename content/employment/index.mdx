...
seo:
  ...
  description: 'Join SSW, work with the latest tech, smart teams, and cross-industry projects. Flexible work options and industry best practices.'
booking:
  ...
  bookingBody: |
    ...
    <UtilityButton buttonText="Internships" link="/training/internship-fullstack" />
...
benefits:
  benefitList:
    ...
    - image: /images/benefits/smart-people.png
      ...
      description: |
        We employ smart people and [they generate some awesome ideas](https://www.ssw.com.au/rules/use-the-brains-of-your-company/).
...
benefitsBody: |
  ...
  <VideoEmbed url="https://www.youtube.com/watch?v=Q2aWUuqaEfU" caption="SSW Brisbane Retreat 2023 - Bli Bli Aqua Park Adventures & Poolside Fun in the Sunshine Coast" duration="2 mins" />

  <UtilityButton buttonText="Watch the playlist" link="https://www.youtube.com/playlist?list=PLpiOR7CBNvlr8T3fyYVxeKbmRp93xTCPM" />
afterBody: |
  # **Recruitment** process at SSW

  Please note: SSW will never contact you via WhatsApp or social media for interviews. Beware of scammers!

  <CustomImage src="/images/Employment/recruitment_doodle.png" altText="SSW Recruitment Process" height={349} width={1093} />
...
opportunities:
  ...
  - opportunityRef: content/opportunities/Solutions-Architect.mdx
callToActionBody: |
  # Don't fit any of the available positions?

  ##### We may still be a match! Tell us why you want to join the SSW team.

  <UtilityButton buttonText="Send email to apply!" link="mailto:lukecook@ssw.com.au?subject=Employment" />
---
