...
_body:
  - trainingInformationItems:
      - header: <span class="text-sswRed text-5xl">Who</span> should apply?
        body: |
          <VerticalListItem
            content={<>
              University students studying an IT degree
          ...
          />
      - header: <span class="text-sswRed text-5xl">What</span> do you get?
        body: |
          <VerticalListItem
            content={<>
          ...
          <VerticalListItem
            ...
            iconScale={0.8}
          />
      - header: <span class="text-sswRed text-5xl">When</span> does it run?
        body: >
          Starts every Monday.
