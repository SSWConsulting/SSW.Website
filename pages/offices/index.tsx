			...
			<Container className="flex-1 gap-8 pt-2 md:grid md:grid-cols-7">
				<div className="md:col-span-5">
					...
					<div className="border-2 bg-gray-100 px-4 py-2">
						<p>
							Our staff are ready to work remotely for any country globally. We
							have worked for clients from the
					...
					<br />
					<p>
						Visit our worldwide website: <a href="https://ssw.com/">ssw.com.</a>
					</p>
				</div>
