...
const OfficeLayout = ({ office }) => {
  return (
    <div className="prose max-w-full">
      ...
      {office.map ? (
        <>
          <div data-tina-field={tinaField(office, "addressLocality")}>
            <h2>SSW {office.addressLocality} Map</h2>
          </div>
          <div data-tina-field={tinaField(office, "map")}>
            <Image
              src={office.map}
              width={1920}
              height={1080}
      ...
      <h4 data-tina-field={tinaField(office, "directionsUrl")}>
      ...
      {office._body.children.length > 0 && (
        <>
          <hr />
          <div data-tina-field={tinaField(office, "body")}>
            <TinaMarkdown
              components={componentRenderer}
