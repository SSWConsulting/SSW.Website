...
ARG NEXT_PUBLIC_PULL_REQUEST_ID
ENV NEXT_PUBLIC_PULL_REQUEST_ID $NEXT_PUBLIC_PULL_REQUEST_ID
ARG NEXT_PUBLIC_APP_SERVICE_NAME
ENV NEXT_PUBLIC_APP_SERVICE_NAME $NEXT_PUBLIC_APP_SERVICE_NAME
